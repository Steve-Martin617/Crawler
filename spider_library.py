...
def getLinks(pageUrl):
    """
    Scraping all links on the input webpage
    """
...
def getText(pageUrl):
    """
    Scraping all text on the input webpage
    """
...
def getTitle(pageUrl):
    """
    Scraping the title on the input webpage
    """
...
def getParagraphs(pageUrl):
    """
    Scraping the paragraphs on the input webpage
    """
...
def scrape_sites(pageURL):
    """
    Holistic scraper of titles, links, text and paragraphs looping through all connected webpages
    """
